				...
				<div class="panel-body" style="margin top : 20px" >
					<form action="" method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="emp" id="eid" placeholder="Enter id fromat: E123" required />
						</div>
						<div class="form-group">
						...
						<div class="row">
							<div style="align-items: center;padding-left: 3%;">
								<input class= "btn btn-info" type="submit" value="Login" name="submit" />
